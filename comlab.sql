...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2025 at 10:17 AM
...
INSERT INTO `faculty` (`facultyID`, `fullname`, `gender`, `age`, `email`, `contact`, `datehired`, `username`, `password`) VALUES
(1, 'Neil A Mutia', 'male', 27, 'mutia@gmail.com', '09123456789', '2025-05-05 07:35:36', 'neil1234', 'nam12345'),
(2, 'crab king', 'male', 23, 'king@gmail.com', '09873463442', '2025-05-22 06:28:25', 'jhon', '123'),
(3, 'maramag', 'male', 23, 'mara@gmail.com', '0946627311', '2025-05-04 16:00:00', 'manji', '12345678'),
(23412, 'rogene abijay', 'male', 31, 'rogene@gmail.com', '091234567893', '2025-05-05 16:00:00', 'rogene', '12345678'),
(23413, 'lalah', 'mali', 23, 'lalah@gmail.com', '0932874', '2025-05-22 16:00:00', 'lalah', 'lalah');
...
INSERT INTO `performance` (`id`, `student_id`, `score`, `task_id`, `file`, `file_path`, `message`) VALUES
...
INSERT INTO `student` (`studentID`, `lastname`, `firstname`, `gender`, `age`, `address`, `email`, `contact`, `username`, `password`) VALUES
(1, 'canedo', 'jonathan', 'male', 23, '0912345678', 'jonathan01@gmail.com', 912345678, 'nathan', '090807'),
(23, 'bahinting', 'rejeans', 'female', 24, '0977443242', 'rejean@gmail.com', 977443242, 'rejean', '12345678'),
(26, 'plenos', 'via', 'female', 23, 'prk 5', 'via@gmail.com', 912345678, 'via', '12345678'),
(27, 'lah', 'lah', 'mali', 32, 'lasdk', 'lah@gmail.com', 999999999, 'lah', 'lah');
...
INSERT INTO `subject` (`id`, `code`, `description`, `instructor_id`) VALUES
(437, 'ITP 135', 'Application Development', 1),
(438, 'ITBAN3', 'Applicatoin', 1),
(439, 'ITP 135', 'App', 23413);
...
INSERT INTO `tasks` (`task_id`, `task`, `status`, `subject_id`, `duration`, `instructor_id`, `task_code`, `description`) VALUES
(8, 'Activity 2', 'Pending', 437, 1, 1, '123123', 'MNSADuiohefoaASDfMNSADuiohefoaASDfMNSADuiohefoaASDfMNSADuiohefoaASDfMNSADuiohefoaASDfMNSADuiohefoaASDfMNSADuiohefoaASDfMNSADuiohefoaASDfMNSADuiohefoaASDfMNSADuiohefoaASDfMNSADuiohefoaASDfMNSADuiohefoaASDfMNSADuiohefoaASDf'),
(9, 'Activity 10', 'Pending', 438, 1, 1, 'act10-123', 'nfhvlutb;wije');
...
--
ALTER TABLE `student`
  MODIFY `studentID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
